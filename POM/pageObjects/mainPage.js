...
class MainPage {
  ...
  locators = {
    getMenTshirtViewProductButton: () =>
      this.page.locator("a[href='/product_details/2']"),
    getMenButtonFromCategory: () =>
      this.page.locator(".panel-title a[href='#Men']"),
    getWomenButtonFromCategory: () =>
      this.page.locator(".panel-title a[href='#Women']"),
    getSareeLinkFromWomenCategory: () =>
      this.page.locator("a[href='/category_products/7']"),
    getJeansLinkFromMenCategory: () =>
